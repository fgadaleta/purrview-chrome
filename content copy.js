// FeedLens Content Script
console.log('FeedLens: Content script loaded');
...
// Create and inject sidebar on page load
injectSidebar();
...
function injectSidebar() {
  ...
  toggleBtn.innerHTML = '📊';
  toggleBtn.title = 'Toggle FeedLens';
    ...
    <div class="feedlens-container">
      ...
      <div class="feedlens-stats-container">
        <div class="feedlens-stat-box left">
          ...
          <div class="feedlens-stat-value" id="feedlens-left">0</div>
        ...
        <div class="feedlens-stat-box center">
          ...
          <div class="feedlens-stat-value" id="feedlens-center">0</div>
        ...
        <div class="feedlens-stat-box right">
          ...
          <div class="feedlens-stat-value" id="feedlens-right">0</div>
...
async function updateSidebarStats() {
  ...
  document.getElementById('feedlens-left').textContent = stats.left || 0;
  document.getElementById('feedlens-center').textContent = stats.center || 0;
  document.getElementById('feedlens-right').textContent = stats.right || 0;
  document.getElementById('feedlens-total').textContent = stats.total || 0;
...
// Main function to analyze the feed
async function analyzeFeed() {
  ...
  for (const tweet of tweets) {
    ...
    // Extract tweet ID if on search page
    if (isSearchPage) {
...
function extractTweetId(tweetElement) {
  try {
    ...
    // Method 2: Check time element which often has a link to the tweet
